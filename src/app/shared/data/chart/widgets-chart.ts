import {
  ...
  SkillStatusChart,
  StockMarketChart,
  TotalSaleChartOption,
  TurnOverCharts,
  UsersChart,
} from '../../interface/widgets/chart';

var primary = localStorage.getItem('--theme-deafult') || '#7366ff';
var secondary = localStorage.getItem('--theme-secondary') || '#FF8575';

//Total Sale Chart
export const TotalSaleChart: TotalSaleChartOption = {
  chart: {
    toolbar: {
      show: false,
    },
...
//Total Project Chart
export const TotalProjectChart: TotalSaleChartOption = {
  chart: {
    toolbar: {
      show: false,
    },
...
//Total Product Chart
export const TotalProductChart: TotalSaleChartOption = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const detailsChart: TotalSaleChartOption[] = [
  TotalSaleChart,
  TotalProjectChart,
  TotalProductChart,
];
...
// Order Status
export const orderPacked: OrderChartOptions = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const orderDispatched: OrderChartOptions = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const orderReached: OrderChartOptions = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const orderOutOfDelivery: OrderChartOptions = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
export const orderDelivered: OrderChartOptions = {
  chart: {
    height: 70,
    type: 'bar',
    stacked: true,
...
// Live Product
export const liveProduct: LiveProductChart = {
  chart: {
    height: 320,
    type: 'area',
    toolbar: {
...
// Turn Over
export const turnOver: TurnOverCharts = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const cryptoCurrencyPrice: CryptoCurrencyPriceChart = {
  chart: {
    toolbar: {
      show: false,
    },
...
export const cryptoAnnotation: CryptoAnnotationChart = {
  series: [
    {
...
// Stoke Market
export const stokeMarket: StockMarketChart = {
  series: [
    {
      name: 'line',
      type: 'line',
...
export const finance: FinanceChart = {
  chart: {
    height: 350,
    type: 'line',
    toolbar: {
...
// Order Status 2
export const orderStatus2: OrderStatusChart2 = {
  chart: {
    height: 350,
    type: 'line',
    stacked: true,
