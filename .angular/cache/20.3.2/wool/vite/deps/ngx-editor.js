...
function DropdownComponent_div_4_button_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction2(8, _c4, item_r2 === ctx_r2.activeItem, ctx_r2.disabledItems.includes(item_r2)));
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function ToggleCommandComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵproperty("disabled", ctx.disabled)("innerHTML", ɵɵpipeBind1(1, 8, ctx.html), ɵɵsanitizeHtml)("title", ɵɵpipeBind1(2, 10, ctx.getTitle(ctx.name)));
        ɵɵariaProperty("ariaLabel", ɵɵpipeBind1(3, 12, ctx.getTitle(ctx.name)));
      }
    },
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function InsertCommandComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵproperty("disabled", ctx.disabled)("innerHTML", ɵɵpipeBind1(1, 6, ctx.html), ɵɵsanitizeHtml)("title", ɵɵpipeBind1(2, 8, ctx.getTitle(ctx.name)));
        ɵɵariaProperty("ariaLabel", ɵɵpipeBind1(3, 10, ctx.getTitle(ctx.name)));
      }
    },
    dependencies: [AsyncPipe, SanitizeHtmlPipe],
    encapsulation: 2
